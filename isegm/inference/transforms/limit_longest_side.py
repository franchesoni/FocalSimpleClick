...
class LimitLongestSide(ZoomIn):
    ...
    def transform(self, image_nd, clicks_lists):
        ...
        self._roi_image = get_roi_image_nd(image_nd, self._object_roi, self.target_size, resize=False)  # compatible with the last return statement, output shape isn't `target_size``
